...
export const NavBar = () => {
  ...
  return (
    <header className="text-white bg-background py-4 px-6 w-full border-b-green-400 gradient-border-bottom shadow-2xl">
      <div className="flex justify-between items-center w-full">
        ...
        <div className="flex space-x-4">
          <button className="bg-custom_gray text-white py-2 px-5 rounded">Withdraw</button>
